...
#include "../../../openCVDemo2/opencvworker.h"
...
QT_MOC_LITERAL(4, 39, 16), // "receiveGrabFrame"
QT_MOC_LITERAL(5, 56, 12), // "receiveSetup"
QT_MOC_LITERAL(6, 69, 6), // "device"
QT_MOC_LITERAL(7, 76, 19), // "receiveToggleStream"
QT_MOC_LITERAL(8, 96, 28), // "receiveEnableBinaryThreshold"
QT_MOC_LITERAL(9, 125, 22), // "receiveBinaryThreshold"
QT_MOC_LITERAL(10, 148, 9) // "threshold"

    },
    "OpenCvWorker\0sendFrame\0\0frameProcessed\0"
    "receiveGrabFrame\0receiveSetup\0device\0"
    "receiveToggleStream\0receiveEnableBinaryThreshold\0"
    "receiveBinaryThreshold\0threshold"
};
...
void OpenCvWorker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->receiveGrabFrame(); break;
        case 2: _t->receiveSetup((*reinterpret_cast< const int(*)>(_a[1]))); break;
        case 3: _t->receiveToggleStream(); break;
        case 4: _t->receiveEnableBinaryThreshold(); break;
        case 5: _t->receiveBinaryThreshold((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (OpenCvWorker::*)(QImage );
...
QT_INIT_METAOBJECT const QMetaObject OpenCvWorker::staticMetaObject = {
